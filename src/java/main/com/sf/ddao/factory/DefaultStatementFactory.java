...
public class DefaultStatementFactory implements StatementFactory {
    ...
    public PreparedStatement createStatement(Connection connection, Object[] args, int autoGeneratedKeys) throws StatementFactoryException {
        String stmt = null;
        try {
            stmt = createText(args);
            log.fine(stmt);
    ...
    public String createText(Object[] args) throws StatementParameterException {
